...
(function (global) {
  ...
  var CALLIGRAPHY_FAMILIES = [
      ...
      },
      {
        ...
        label: "ثلث",
        labelEn: "Thuluth",
        blurb: "خط الثلث بحروفه المنحنية الانسيابية. يضم متغيّرين حقيقيّين موثّقَي المصدر: (Khotot) برخصة GPL v2، و(Layla) برخصة SIL OFL 1.1 — كلاهما بلا طقوم أسلوبية OpenType حقيقية، فيظهران بمتغيّر افتراضي واحد بأمانة لكل منهما بدلًا من اختلاق متغيّرات. خط Layla لا يحتوي على جدول GPOS، فتُستخدم علامات التشكيل المفردة وتموضع المحرر للعلامات المركّبة (تسع علامات مفردة من أصل 12 مدعومة فعليًا؛ راجع PHASE10C_REPORT.md وPHASE10D_REPORT.md للتفاصيل الكاملة).",
        available: true,
        variations: [
          { id: "thuluth-tholoth", label: "ثلث (Khotot)", file: "tholoth/Tholoth-Regular.woff2", weight: 400, features: [], meta: "افتراضي", metaEn: "Default" },
          { id: "thuluth-layla", label: "ثلث (Layla)", file: "laylathuluth/LaylaThuluth-Regular.woff2", weight: 400, features: [], meta: "افتراضي", metaEn: "Default" }
        ]
      },
      {
        id: "quranic",
      ...
      },
      {
        ...
        label: "ديواني",
        labelEn: "Diwani",
        blurb: "خط ديواني تقليدي أصيل (UKIJ Diwani Tom، إصدار 2011) — مرخّص بترخيص OFL-1.1. لا يحتوي على بيانات GPOS للتموضع المتبادل؛ تُحسب مواضع علامات التشكيل المركّبة داخل المحرر.",
        available: true,
        variations: [
          { id: "diwani-ukijdiwanitom", label: "ديواني (UKIJ Diwani Tom)", file: "ukijdiwanitom/UKIJDiwaniTom-Regular.woff2", weight: 400, features: [], meta: "افتراضي", metaEn: "Default" }
        ]
      },
      {
        id: "ijazah",
